...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = [
    ...
    { url: `${baseUrl}/services/antikrizisnyy-audit-590p`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.9 },
    ...
    { url: `${baseUrl}/services/ocenka-biznesa`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.85 },
