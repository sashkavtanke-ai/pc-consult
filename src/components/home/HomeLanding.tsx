...
const benefits = [
  'Собираем на одной странице ключевые форматы работы и популярные услуги.',
  'Говорим с собственником на языке прибыли, рисков, сроков и конкретных действий.',
  'Оставляем отдельные страницы услуг для SEO и рекламы, а главную делаем продающей.',
];
